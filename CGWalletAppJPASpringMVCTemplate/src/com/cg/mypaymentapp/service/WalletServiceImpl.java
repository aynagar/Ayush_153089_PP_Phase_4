...
public class WalletServiceImpl implements WalletService {
	...
	public Customer createAccount(Customer customer) {
		...
		String details = "Wallet with mobile number: "+customer.getMobileNo()+" created with "+ customer.getWallet().getBalance()+" on "+dateFormat.format(dateOfTransaction)+".";
		Transactions transactions = new Transactions();
		transactions.setMobileNo(customer.getMobileNo());
	...
	public List<Customer> getAllCustomersWithInsufficientBal() {
		...
		return repo.findAllWithInsufficientBal();
	}
