...
public class CustomerActionController {
	...
	public ModelAndView ShowAll() {
		...
		ModelAndView model = new ModelAndView("GetAllPage");
		
	
		try {
			customersList=walletService.getAllCustomers();
			model.addObject("customers", customersList);
	...
	@RequestMapping(value="/getAllWithLessBal")
	public ModelAndView ShowAllcustomersWithInsufficient() {
		List<Customer> customersList;
		
		ModelAndView model = new ModelAndView("GetAllWithInsufficientBal");
		
		try {
			customersList=walletService.getAllCustomersWithInsufficientBal();
			model.addObject("customers", customersList);
